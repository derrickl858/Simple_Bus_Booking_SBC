<?php
	...
	$driverName = mysqli_real_escape_string($con, trim($_POST['driverName']));
	...
	$registeredOwnerIC = mysqli_real_escape_string($con, trim($_POST['registeredOwnerIC']));

	$sql = mysqli_query($con, "INSERT INTO driver VALUES ('$driverName', '$ic', '$license', '$phoneNo', '$registeredOwnerIC')");
?>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Create new driver is SUCCESSFUL!</p>
				</div>
	...
	<div class="modal fade" id="failureModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<p>Create new driver is FAILED!</p>
				</div>
				<div class="modal-footer">
